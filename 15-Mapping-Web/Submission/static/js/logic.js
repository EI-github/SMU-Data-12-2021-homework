...
// using Ajax instead of D3, leaving this function active anyway
...
function createMap(data, plate_data) {
    ...
    legend.onAdd = function() {
        ...
        var labels = ["<h1><center>Depth</center></h1>","<10", "10-30", "30-70", "70+"];
        var colors = ["white", "#00A650", "#CCBD00", "#F36523", "#BA131A"];
